    ...
    <div className="max-w-7xl mx-auto space-y-10 pb-12 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
         {filteredTools.map((tool) => (
            ...
            >
               <div className="w-12 h-12 rounded-xl bg-cyan-50 text-cyan-600 flex items-center justify-center text-xl mb-4 group-hover:scale-110 transition-transform">
               ...
               <div className="flex items-center text-xs font-bold text-slate-400 group-hover:text-cyan-600 uppercase tracking-wider">
                  Use Tool <i className="fa-solid fa-arrow-right ml-2"></i>
               </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[2rem] w-full max-w-2xl overflow-hidden relative z-10 shadow-2xl animate-scale-in flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                  ...
                  {activeTool.inputs.map(input => (
                    <div key={input.key}>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 outline-none transition-all font-medium text-slate-700"
               ...
               {result && (
                  <div className="bg-slate-900 rounded-xl p-5 text-white animate-fade-in-up shadow-inner relative overflow-hidden group">
            ...
            <div className="p-5 border-t border-slate-100 bg-slate-50">
               <button 
                 ...
                 disabled={loading}
                 className={`w-full py-4 rounded-xl font-bold text-white shadow-lg transition-all flex items-center justify-center gap-2 ${loading ? 'bg-slate-400 cursor-not-allowed' : 'bg-cyan-600 hover:bg-cyan-700 hover:-translate-y-0.5 shadow-cyan-500/30'}`}
               >
