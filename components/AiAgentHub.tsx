...
const AiAgentHub: React.FC = () => {
  ...
  const handleConsult = async () => {
    ...
    try {
      const response = await generateText(input, activeAgent.systemInstruction);
      setResult(response);
    } catch (e) {
  ...
  return (
    <div className="max-w-7xl mx-auto pb-12 animate-fade-in">
      ...
      {/* Hero Section */}
      <div className="bg-slate-900 rounded-[3rem] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl mb-12">
      ...
      {/* Search & Selection UI */}
      <div className="max-w-2xl mx-auto mb-10 px-4 flex flex-col md:flex-row gap-4">
          ...
          <div className="bg-white w-full max-w-4xl h-[85vh] rounded-3xl shadow-2xl relative z-10 flex flex-col overflow-hidden animate-scale-in">
             ...
             <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                ...
                <button 
                  ...
                  className="w-10 h-10 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-slate-700 hover:bg-slate-50 flex items-center justify-center transition-all"
                >
             ...
             <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-white flex flex-col gap-6 custom-scrollbar">
                ...
                <div className="flex items-start gap-4 animate-fade-in-up">
                   ...
                   <div className="bg-slate-50 border border-slate-100 rounded-2xl rounded-tl-none p-5 text-slate-700 leading-relaxed shadow-sm max-w-3xl">
                      ...
                      Hello. I am {activeAgent.name}. {activeAgent.description} How can I assist you with your task today?
                   </div>
                </div>
