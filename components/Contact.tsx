...
const FormTooltip = ({ text }: { text: string }) => (
  <div className="group relative inline-block ml-2 align-middle">
    <i className="fa-solid fa-circle-info text-slate-400 hover:text-indigo-500 cursor-help transition-colors text-xs"></i>
    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-800 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 text-center shadow-lg pointer-events-none font-medium">
      {text}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2 ml-1">
                  Your Name
                  <FormTooltip text="Please enter your full name as you'd like us to address you." />
                </label>
                <input 
                  type="text" 
                  required
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2 ml-1">
                  Email Address
                  <FormTooltip text="We'll use this to reply to your inquiry. No spam." />
                </label>
                <input 
                  type="email" 
                  required
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2 ml-1">
                  Message
                  <FormTooltip text="Describe your project, question, or feedback in detail." />
                </label>
                <textarea 
                  rows={4}
                  required
